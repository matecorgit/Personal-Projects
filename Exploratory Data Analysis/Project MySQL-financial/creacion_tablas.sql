...
LOAD DATA LOCAL INFILE '"C:\Users\PC\OneDrive\Escritorio\Cursos\Data\SQL\MySQL\Base de datos\Proper_loan_data\prosperLoanData.csv"' 
INTO TABLE prosperloandata_temp FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
